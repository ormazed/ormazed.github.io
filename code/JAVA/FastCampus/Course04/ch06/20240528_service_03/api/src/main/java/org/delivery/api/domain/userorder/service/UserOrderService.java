...
public class UserOrderService {
    ...
    // 상태변경 메서드 : 주문확인, 조리시작, 배달시작 등은 상태변경으로 볼 수 있다.
    ...
    // ## 추가
    // 현재 주문 내역
    public List<UserOrderEntity> current(Long userId){ // userId 가 주문한 주문목록을 확인
    ...
    // 과거 주문 내역
    public List<UserOrderEntity> history(Long userId){ // userId 가 주문한 주문목록을 확인
        return getUserOrderList
                (
                        userId,
                        List.of(
